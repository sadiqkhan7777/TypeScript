...
//     console.log(message)
// )
var helloPromise = new Promise(function (rej, resolve) {
    setTimeout(function () {
        resolve("hello , world!");
    }, 1000);
});
...
//     console.log(message)
// )
var SirZiaPromise = new Promise(function (res, rej) {
    return res("passed out");
});
SirZiaPromise.then(function (status) {
    console.log(status);
});
SirZiaPromise
...
function checkSirZiaPromise() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, SirZiaPromise];
                case 1:
                    promiseVal = _a.sent();
